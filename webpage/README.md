...
* [`src/webpage/`](src/webpage/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/webpage/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `webpage` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/webpage/config.cljs) defaults to `true` in
...
```clj
(ns webpage.example
  (:require [webpage.config :as config])
